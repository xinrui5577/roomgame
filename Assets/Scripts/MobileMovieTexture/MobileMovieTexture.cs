...
namespace MMT
{
    public class MobileMovieTexture : MonoBehaviour
    {
        ...
        /// </summary>
        [SerializeField]
        private List<Material> m_movieMaterials = new List<Material>();
        ...
        /// </summary>
        public List<Material> MovieMaterial
        {
            get
            {
        ...
        public double Duration
        {
            get
            {
                return m_nativeContext != IntPtr.Zero ? GetDuration(m_nativeContext) : 0.0;
            }
        }
    ...
    private const string PLATFORM_DLL = "__Internal";
        ...
        public void CreateMovie()
        {
            ...
            if ( m_nativeContext == IntPtr.Zero )
            {
                Debug.Log("Unable to create Mobile Movie Texture native context");
                return;
            }
...
//            }
        ...
        private void DoOpen()
        {
            ...
            YxDebug.Log(" movie Open path:" + path);
        ...
        private void AllocateTexures()
        {
            ...
            {
                for ( int i = 0; i < m_movieMaterials.Count; ++i )
                {
