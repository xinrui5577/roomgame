...
{
    public class RedPacketMyWalletWindow : YxNguiRedPacketWindow
    {
        ...
        {
            Facade.Instance<TwManager>().SendAction("RedEnvelope.freshUserData", new Dictionary<string, object>(), null, true, null, false);
        }
