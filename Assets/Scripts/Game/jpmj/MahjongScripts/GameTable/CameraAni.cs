...
namespace Assets.Scripts.Game.jpmj.MahjongScripts.GameTable
{
    public class CameraAni : MonoBehaviour
    {
        ...
        private void SetCamera()
        {
            ...
            {
                transform.localPosition = GameAdpaterManager.Singleton.GetConfig.MahjongCamera_Pos;
                GetComponent<Camera>().fieldOfView = GameAdpaterManager.Singleton.GetConfig.MahjongCamera_FieldOfView;  
            }
        }
