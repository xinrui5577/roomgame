...
namespace Assets.Scripts.Game.Ttzkf
{
    public class RoomInfoCtrl : MonoBehaviour
    {
        ...
        public void InitRoomInfo(int roomNum, string[] infos, string bankType)
        {
            ...
            {
                GameObject.Find("UI Root/Camera/Game/RoomInfo/Grid/RoomID").SetActive(false);
                GameObject.Find("UI Root/Camera/Game/RoomInfo/Grid/GameNum").SetActive(false);
                GameObject.Find("UI Root/Camera/Game/RoomInfo/Grid/Seat").SetActive(false);
                GameObject.Find("UI Root/Camera/Game/RoomInfo/Grid/Ante").SetActive(false);
            }
        ...
        public void GameNumChange(int num)
        {
            ...
            var totalRound = "[ffffff]" + App.GetGameData<TtzGameData>().MaxRound;
