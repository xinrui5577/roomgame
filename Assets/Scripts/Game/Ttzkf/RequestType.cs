...
namespace Assets.Scripts.Game.Ttzkf
{
    ...
    {
        public const string ZeroCount = "闭十";
        public const string OneCount = "一点";
        public const string TwoCount = "二点";
        public const string ThreeCount = "三点";
        public const string FourCount = "四点";
        public const string FiveCount = "五点";
        public const string SixCount = "六点";
        public const string SevenCount = "七点";
        public const string EightCount = "八点";
        public const string NineCount = "九点";
        public const string ErBaGang = "二八杠";
        public const string DuiZi = "对子";
        public const string TianDui = "对十";
    }
