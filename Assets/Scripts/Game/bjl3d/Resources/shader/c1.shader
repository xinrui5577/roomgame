...
Shader "Shader Forge/c1" {
    Properties {
        _node_7373 ("node_7373", 2D) = "white" {}
    ...
    SubShader {
        ...
        Pass {
            ...
            #endif
            uniform sampler2D _node_7373; uniform float4 _node_7373_ST;
...
/////// Diffuse:
                ...
                float4 _node_7373_var = tex2D(_node_7373,TRANSFORM_TEX(i.uv0, _node_7373));
                float3 diffuse = (directDiffuse + indirectDiffuse) * _node_7373_var.rgb;
////// Emissive:
                ...
                float3 emissive = ((_node_7373_var.rgb*1.0)+(float3(0.875,0.7105343,0.5082721)*(1.5*_node_4377_var.rgb)));
/// Final Color:
                float3 finalColor = diffuse + emissive;
                fixed4 finalRGBA = fixed4(finalColor,_node_7373_var.a);
...
/////// Diffuse:
                ...
                float3 directDiffuse = max( 0.0, NdotL) * attenColor;
                float4 _node_7373_var = tex2D(_node_7373,TRANSFORM_TEX(i.uv0, _node_7373));
                float3 diffuse = directDiffuse * _node_7373_var.rgb;
/// Final Color:
                float3 finalColor = diffuse;
                return fixed4(finalColor * _node_7373_var.a,0);
            }
            ENDCG
        }
    }
