...
namespace Assets.Scripts.Game.GangWu.Tool
{
    public class Tools : MonoBehaviour {
        ...
        public static void SetBtnCouldClick(GameObject button, bool couldClick)
        {
            UIButton btn = button.GetComponent<UIButton>();
            BoxCollider btnCollider = button.GetComponent<BoxCollider>();
           
            btnCollider.enabled = couldClick;
