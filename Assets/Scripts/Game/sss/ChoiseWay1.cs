...
using CnList = Assets.Scripts.Game.sss.Help1.CnList;
using VnList = Assets.Scripts.Game.sss.Help1.VnList;
using SssDun = Assets.Scripts.Game.sss.Help1.SssDun;
...
namespace Assets.Scripts.Game.sss
{
    public class ChoiseWay1 : ChoiseMgr
    {
        ...
        /// 特殊牌型按钮
        /// </summary>
        private Help1.PlayerDuns _specialDuns;
        ...
        {
            if (_specialDuns == null || _specialDuns.Special <= CardType.none) return;  //如果没有特殊牌型,不予处理

            _selectInfo.CardType = _specialDuns.Special;
            int len = Lines.Length;
