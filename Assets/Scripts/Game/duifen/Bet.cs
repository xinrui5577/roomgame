...
namespace Assets.Scripts.Game.duifen
{
    public class Bet : MonoBehaviour
    {
        ...
        /// <param name="flyTime">风行时间</param>
        /// <param name="callback">回调函数</param>
        public void BeginMove(Vector3 from, Vector3 to, float delay = 0, BetFinishedType fType = BetFinishedType.None, float flyTime = 0.3f, Action callback = null)
        {
        ...
        ///// <param name="fType">筹码移动后的状态类型</param>
        ///// <param name="callback">回调函数</param>
        //public void BeginMove(Vector3 from, float delay = 0, BetFinishedType fType = BetFinishedType.None, Action callback = null)
        //{
        //    Vector3 to = GetRandomTargetPos();
        //    gameObject.SetActive(true);
        //    CurFinishedType = fType;
        //    Tp.from = from;
        //    Tp.to = to;
