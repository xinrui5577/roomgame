...
namespace Assets.Scripts.Game.brnn
{
    public class DeskCtrl : MonoBehaviour
    {
        ...
        {
            App.GetGameManager<BrnnGameManager>().ParticleCtrl.SetParticleEffect(2, p);
            switch (p)
            {
                case 0:
