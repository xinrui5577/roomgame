...
{
    public class JpmjSssPokerCard : MonoBehaviour
    {
        /// <summary>
        /// 花色
        /// </summary>
        ...
        public void SetPokerScale(float x, float y)
        {
            Num.transform.localScale = new Vector3(x, y, 1);           
            BigColor.transform.localScale = new Vector3(x, y, 1);
            SmallColor.transform.localScale = new Vector3(x, y, 1);
        }
    }
}
